...
<head>
	...
	<br><br>	
		<h2 id="mensaje_bienvenida">Pedido de cambio de maquina</h2>
<br>
<br>
	...
	<div id="opc">
		...
		<div class="caja">
			...
			<input type="submit" value="Enviar pedido de cambio" class="button yellow hvr-radial-out" id="submit">
		</form>
