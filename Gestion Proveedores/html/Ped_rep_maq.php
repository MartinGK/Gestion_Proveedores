...
<head>
	...
	<br><br>	
		<h2 id="mensaje_bienvenida">Pedido de reparacion de maquina</h2>
<br>
<br>
	...
	<div id="opc">
		...
		<div class="caja">
			...
			<input type="submit" value="Enviar pedido de reparacion" class="button yellow hvr-radial-out" id="submit" >
		</form>
	</div>
</html>