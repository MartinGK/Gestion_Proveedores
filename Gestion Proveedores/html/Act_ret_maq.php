...
<head>
	...
	<br><br>	
		<h2 id="mensaje_bienvenida">Actualizacion: Retiro de maquina </h2>
<br>
<br>
<div id="opc">
...
<div class="caja">
			<label for="nro_maquina" class="label">Ingrese el numero de maquina</label><br>
			<input type="text" name="nro_maquina" id="nro_maquina" class="input-text">
</div>
<br><br>
<div class="caja">
...
<br><br>
			...
			<input type="submit" value="Maquina retirada" class="button yellow hvr-radial-out" id="submit">
		</form>
